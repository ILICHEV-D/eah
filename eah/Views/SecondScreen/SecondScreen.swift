                ...
                ScrollView(.vertical, showsIndicators: /*@START_MENU_TOKEN@*/true/*@END_MENU_TOKEN@*/, content: {
                    VStack{
                        ...
                        if viewModel.breakfast.count != 0 {
                            ...
                            NavigationLink(
                                destination: ListOfMeals(items: viewModel.allMeals, index: 0, check: "breakfast"),
                                label: {
                        ...
                        if viewModel.lunch.count != 0 {
                            ...
                            NavigationLink(
                                destination: ListOfMeals(items: viewModel.allMeals, index: 0, check: "lunch"),
                                label: {
                        ...
                        if viewModel.dinner.count != 0 {
                            ...
                            NavigationLink(
                                destination: ListOfMeals(items: viewModel.allMeals, index: 0, check: "dinner"),
                                label: {
...
struct MealAddMore: View {
    ...
    var body: some View {
        ...
        HStack{
            ...
            Spacer()
            NavigationLink(
                destination: ListOfMeals(items: viewModel.allMeals, index: 0, check: check),
                label: {
                    Text("Добавить")
